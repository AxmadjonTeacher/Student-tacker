...
export const mapDbToStudent = (db: any): Student => ({
  ...
  engScore: db.eng_score !== null && db.eng_score !== undefined ? Number(db.eng_score) : null,
  mathScore: db.math_score !== null && db.math_score !== undefined ? Number(db.math_score) : null,
...
export const mapStudentToDb = (student: Student) => {
  const dbRecord: any = {
    ...
    eng_score: student.engScore !== undefined ? student.engScore : null,
    math_score: student.mathScore !== undefined ? student.mathScore : null,
